		...
		for (int i = 0; i < storyline.getChildCount(); i++) {
			...
			if (m.getStatus() == Storyline.IDLE) {
				badges.add(getBadge(220,
						"/aries/tc/images/icons/check48.png", 
				...
				badges.add(getBadge(220,
						"/aries/tc/images/icons/spinner48.png", 
						m.getTemplate().getTitle(), 
						m.getTemplate().getRunningHead(), 
						"The " +
							m.getTemplate().getTitle() + 
				...
				badges.add(getBadge(220,
						"/aries/tc/images/icons/warning48.png", 
						m.getTemplate().getTitle(), 
						m.getTemplate().getRunningHead(), 
						"The " +
							m.getTemplate().getTitle() + 
				...
				badges.add(getBadge(220,
						"/aries/tc/images/icons/boh48.png", 
						m.getTemplate().getTitle(), 
						m.getTemplate().getRunningHead(), 
						"The " +
							m.getTemplate().getTitle() + 
				...
				badges.add(getBadge(220,
						"/aries/tc/images/icons/check48_green.png", 
						m.getTemplate().getTitle(), 
						m.getTemplate().getRunningHead(), 
						"The " +
							m.getTemplate().getTitle() + 
